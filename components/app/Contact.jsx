        ...
        <div className="contact">
            ...
            <div className="shadow bigContainer">
                ...
                <div className="container">
                    <div>
                        <p><i className="fas fa-phone-square phone"></i> 075 789 781</p>
                        <p><i className="fas fa-envelope-square mail"></i> anilkadriov5@gmail.com</p>
                        <p className="clickable underline"><i className="fab fa-facebook-square"></i> <span className="facebook">Fiziolive</span></p>
                    </div>
